    ...
    include '../../../dbconnect.php';
         ...
         elseif ($type=="one") {
          ...
          if($cntx > 0){
            ...
            $sql = "INSERT INTO quizzes(quizz_id,course_id,problem_number,Question,Option1,Option2,Option3,Option4) VALUES ('$qidx','0','1','$qqq','$o1x','$o2x','$o3x','$o4x','$o1x');";
         ...
         elseif ($type=="two") {
          ...
          if($cntx > 0){
            ...
            $sql = "INSERT INTO quizzes(quizz_id,course_id,problem_number,Question,Option1,Option2,Option3,Option4) VALUES ('$qidx','0','2','$qqq','$o1x','$o2x','$o3x','$o4x','$o1x');";
         ...
         elseif ($type=="three") {
          ...
          if($cntx > 0){
            ...
            $sql = "INSERT INTO quizzes(quizz_id,course_id,problem_number,Question,Option1,Option2,Option3,Option4) VALUES ('$qidx','0','3','$qqq','$o1x','$o2x','$o3x','$o4x','$o1x');";
          ...
          if($cntx > 0){
            ...
            $sql = "INSERT INTO quizzes(quizz_id,course_id,problem_number,Question,Option1,Option2,Option3,Option4) VALUES ('$qidx','0','4','$qqq','$o1x','$o2x','$o3x','$o4x','$o1x');";
         ...
         elseif ($type=="five") {
          ...
          if($cntx > 0){
            ...
            $sql = "INSERT INTO quizzes(quizz_id,course_id,problem_number,Question,Option1,Option2,Option3,Option4) VALUES ('$qidx','0','5','$qqq','$o1x','$o2x','$o3x','$o4x','$o1x');";
         ...
         elseif ($type=="six") {
          ...
          if($cntx > 0){
            ...
            $sql = "INSERT INTO quizzes(quizz_id,course_id,problem_number,Question,Option1,Option2,Option3,Option4) VALUES ('$qidx','0','6','$qqq','$o1x','$o2x','$o3x','$o4x','$o1x');";
         ...
         elseif ($type=="seven") {
          ...
          if($cntx > 0){
            ...
            $sql = "INSERT INTO quizzes(quizz_id,course_id,problem_number,Question,Option1,Option2,Option3,Option4) VALUES ('$qidx','0','7','$qqq','$o1x','$o2x','$o3x','$o4x','$o1x');";
         ...
         elseif ($type=="eight") {
          ...
          if($cntx > 0){
            ...
            $sql = "INSERT INTO quizzes(quizz_id,course_id,problem_number,Question,Option1,Option2,Option3,Option4) VALUES ('$qidx','0','8','$qqq','$o1x','$o2x','$o3x','$o4x','$o1x');";
         ...
         elseif ($type=="nine") {
          ...
          if($cntx > 0){
            ...
            $sql = "INSERT INTO quizzes(quizz_id,course_id,problem_number,Question,Option1,Option2,Option3,Option4) VALUES ('$qidx','0','9','$qqq','$o1x','$o2x','$o3x','$o4x','$o1x');";
         ...
         elseif ($type=="ten") {
          ...
          if($cntx > 0){
            ...
            $sql = "INSERT INTO quizzes(quizz_id,course_id,problem_number,Question,Option1,Option2,Option3,Option4) VALUES ('$qidx','0','10','$qqq','$o1x','$o2x','$o3x','$o4x','$o1x');";
