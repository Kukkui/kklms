...
<?php
	...
	function insertEmployee($params) {
		$data = array();;
		$sql = "INSERT INTO `hardware`(`hw_name`, `hw_type`, `amount`) VALUES ('" . $params["hw_name"] . "', '" . $params["hw_type"] . "','" . $params["amount"] . "');  ";
	...
	function updateEmployee($params) {
		$data = array();
		//print_R($_POST);die;
		$sql = "Update `hardware` set hw_name = '" . $params["hw_name2"] . "', hw_type ='" . $params["hw_type2"]."', amount ='" . $params["amount2"] . "' WHERE id='".$_POST["edit_id"]."'";
