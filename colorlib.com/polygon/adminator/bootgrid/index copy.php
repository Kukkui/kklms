		...
		<table id="employee_grid" class="table table-condensed table-hover table-striped" width="60%" cellspacing="0" data-toggle="bootgrid">
			<thead>
				<tr>
					...
					<th data-column-id="hw_name">hwname</th>
					<th data-column-id="hw_type">hwtype</th>
					<th data-column-id="amount">amount</th>
					<th data-column-id="ram_info">raminfo</th>
					<th data-column-id="mhz_info">mhz</th>
					<th data-column-id="slot_number">slot</th>
					<th data-column-id="current_ram">crrram</th>
					<th data-column-id="max_ram">maxram</th>
					<th data-column-id="spec_link">link</th>
					<th data-column-id="building">building</th>
					<th data-column-id="floor">floor</th>
					<th data-column-id="room_number">roomnum</th>
					<th data-column-id="room_name">roomname</th>
					<th data-column-id="purchase_date">year</th>
					<th data-column-id="user_type">type</th>
            ...
            <div class="modal-body">
				...
				<input type="hidden" value="add" name="action" id="action">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="hw_salary" name="hw_salary"/>
                  </div>
				  <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<input type="hidden" value="0" name="edit_id" id="edit_id">
                  ...
                  <div class="form-group">
                    <label for="salary" class="control-label">Salary:</label>
                    <input type="text" class="form-control" id="hw_type2" name="hw_type2"/>
                  </div>
				  <div class="form-group">
                    <label for="salary" class="control-label">Age:</label>
...
console.log(g_id);
		...
		$('#edit_model').modal('show');
					if($(this).data("row-id") >0) {
                                ...
                                $('#hw_name2').val(ele.siblings(':nth-of-type(2)').html());
                                $('#hw_type2').val(ele.siblings(':nth-of-type(3)').html());
                                $('#amount2').val(ele.siblings(':nth-of-type(4)').html());
					} else {
