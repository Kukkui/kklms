                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <li role="presentation" class="active"><a href="#home" data-toggle="tab">0-1:YEAR</a></li>
                                <li role="presentation"><a href="#profile" data-toggle="tab">1-2:YEARS</a></li>
                                <li role="presentation"><a href="#messages" data-toggle="tab">2-3:YEARS</a></li>
                                <li role="presentation"><a href="#close" data-toggle="tab">3-4:YEARS</a></li>
                                <li role="presentation"><a href="#close2" data-toggle="tab">4-5:YEARS</a></li>

                                <li role="presentation"><a href="#close3" data-toggle="tab">5-6:YEARS</a></li>

                                <li role="presentation"><a href="#close4" data-toggle="tab">6+:YEARS</a></li>
                            </ul>
                            <!-- ///// -->
                            <div class="tab-content">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT id,hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,user_type FROM hardware WHERE hw_name != '' AND age='0' AND  groups='ACCESSORY'";
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT id,hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,user_type FROM hardware WHERE hw_name != '' AND age='1' AND  groups='ACCESSORY'";
                                        $result = mysql_query($sql);
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT id,hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,user_type FROM hardware WHERE hw_name != '' AND age='2' AND  groups='ACCESSORY'";
                                        $result = mysql_query($sql);
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT id,hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,user_type FROM hardware WHERE hw_name != '' AND age='3' AND  groups='ACCESSORY'";
                                        $result = mysql_query($sql);
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="close2">
                                    <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-exportable dataTable">
                                    <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT id,hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,user_type FROM hardware WHERE hw_name != '' AND age='4' AND  groups='ACCESSORY'";
                                        $result = mysql_query($sql);
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="close3">
                                    <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-exportable dataTable">
                                    <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT id,hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,user_type FROM hardware WHERE hw_name != '' AND age='5' AND  groups='ACCESSORY'";
                                        $result = mysql_query($sql);
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="close4">
                                    <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-exportable dataTable">
                                    <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT id,hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,user_type FROM hardware WHERE hw_name != '' AND age !='0' AND age !='1' AND age!='2' AND age!='3' AND age!='4' AND age!='5' AND  groups='ACCESSORY'";
                                        $result = mysql_query($sql);
