...
<div id="myModal2" class="modal">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select id="hwtype2" onclick="send_hwtype()" class="form-control show-tick" data-live-search="true" placeholder="UN-CHANGE">
                                        ...
                                        $sql = " SELECT list FROM ezhwtype WHERE list!='-' AND list!='' GROUP BY list";
                                ...
                                <!-- <div class="col-md-3">
                                    <p>
                                        <b style='color:red'>BUILDING</b>
                                    </p>
                                    <input type="text" readonly value="-" id="building2" class="form-control show-tick" data-live-search="true" placeholder="UN-CHANGE"/>
                                       
                                </div>
                                <div class="col-md-3">
                                    <p>
                                        <b style='color:red'>FLOOR</b>
                                    </p>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" value="-" id="amount2" class="form-control show-tick" data-live-search="true" placeholder="UN-CHANGE" onkeypress='return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57'/>
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <input type="text" value="-" id="info2" class="form-control show-tick" data-live-search="true" placeholder="UN-CHANGE"/>
 ...
 <div class="col-md-3">
                                    ...
                                    <input type="text" value="-" id="brand2" class="form-control show-tick" data-live-search="true" placeholder="UN-CHANGE"/>
 ...
 <div class="col-md-3">
                                    ...
                                    <input type="text" value="-" id="contact2" class="form-control show-tick" data-live-search="true" placeholder="UN-CHANGE"/>
...
<div  class="col-md-12">
 ...
 <br>
                                <div class="col-md-3">
                                    ...
                                    <input type="text" value="-" id="amount3" class="form-control show-tick" data-live-search="true" placeholder="UN-CHANGE" onkeypress='return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57' />
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <input type="text" value="-" id="info3" class="form-control show-tick" data-live-search="true" placeholder="UN-CHANGE"/>
 ...
 <div class="col-md-3">
                                    ...
                                    <input type="text" value="-" id="brand3" class="form-control show-tick" data-live-search="true" placeholder="UN-CHANGE"/>
 ...
 <div class="col-md-3">
                                    ...
                                    <input type="text" value="-" id="contact3" class="form-control show-tick" data-live-search="true" placeholder="UN-CHANGE"/>
...
<script src="../../plugins/multi-select/js/jquery.multi-select.js"></script>
    ...
    window.location.href = "/kis/admin1/pages/tables/ezbulkedit.php?hwname2="+hwname2+"&hwtype2="+hwtype2+"&building2="+building2+"&floor2="+floor2+"&roomnum2="+roomnum2+"&roomname2="+roomname2+"&amount2="+amount2+"&raminfo2="+raminfo2+"&mhzinfo2="+mhzinfo2+"&slot2="+slot2+"&crrram2="+crrram2+"&maxram2="+maxram2+"&paydate2="+paydate2+"&age2="+age2+"&acctypex="+acctypex+"&okid="+str+"&info2="+info2+"&brand2="+brand2+"&contact2="+contact2+"&statusx='-'";
...
function okay3() {
    ...
    var acctypex = '-';
    paydate2=document.getElementById("paydate3").value;
    building2='-';
    floor2='-';
    roomnum2='-';
    roomname2='-';
    ...
    document.getElementById("bulkid").innerHTML=str;
    window.location.href = "/kis/admin1/pages/tables/ezbulkadd.php?hwname2="+hwname2+"&hwtype2="+hwtype2+"&building2="+building2+"&floor2="+floor2+"&roomnum2="+roomnum2+"&roomname2="+roomname2+"&amount2="+amount2+"&raminfo2="+raminfo2+"&mhzinfo2="+mhzinfo2+"&slot2="+slot2+"&crrram2="+crrram2+"&maxram2="+maxram2+"&paydate2="+paydate2+"&link2="+link2+"&acctypex="+acctypex+"&info3="+info3+"&brand3="+brand3+"&contact3="+contact3+"&statusx='-'";
    // prompt(paydate2);
    // prompt(document.getElementById("amount").value);
    // prompt(document.getElementById("raminfo").value);
