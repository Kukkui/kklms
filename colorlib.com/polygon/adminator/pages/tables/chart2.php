                                    ...
                                    <!-- paste here -->
                                        ...
                                        <tr>
                                           <td>
                                            ...
                                            <td>
                                            <?php echo "<button type='button' style='margin-top:20px;' class='btn bg-cyan btn-block btn-sm waves-effect' onclick='toinfo(".")'>"."0-1 YEAR"."</button>";

                                             echo "<button type='button' class='btn bg-cyan btn-block btn-sm waves-effect' onclick='toinfo(".")'>"."1-2 YEARs"."</button>";

                                              echo "<button type='button'  class='btn bg-cyan btn-block btn-sm waves-effect' onclick='toinfo(".")'>"."2-3 YEARs"."</button>";

                                               echo "<button type='button' class='btn bg-cyan btn-block btn-sm waves-effect' onclick='toinfo(".")'>"."3-4 YEARs"."</button>";

                                                echo "<button type='button' class='btn bg-cyan btn-block btn-sm waves-effect' onclick='toinfo(".")'>"."4-5 YEARs"."</button>";

                                                 echo "<button type='button'  class='btn bg-cyan btn-block btn-sm waves-effect' onclick='toinfo(".")'>"."5+ YEARs"."</button>";
                                            ?>
...
<!--   <body>
  ...
  function drawChart() {
        ...
        // Set chart options
        var options = {title : 'Total device ratio in percentage','width':600,'height':400};
