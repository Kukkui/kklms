<?php          
    ...
    // $amount = $_COOKIE['get_amount'];
                                        ...
                                        $anstopic=$_GET["anstopic"];
                                        $anscontent=$_GET["anscontent"];
                                        $ansdate=$_GET["ansdate"];
                                        $ansby=$_GET["ansby"];
                                        ...
                                        if($xarray[0]=="" OR $xarray_size==0){
                                             ...
                                             exit();
                                                  ...
                                                  // // Check connection
                                                            ...
                                                            $sql = "UPDATE `tkinfo` SET `reply_content`='$anscontent',`reply_by`='$ansby',`reply_date`='$ansdate' WHERE `id`='$xarray[$i]'";
                                                  ...
                                                  // $sql = "INSERT INTO `hardwares`(`hwid`,`account`,`date`, `time`, `hw_name`, `hw_type`, `amount`,`ram_info`, `mhz_info`, `slot_number`,`current_ram`, `max_ram`, `spec_link`,`building`, `floor`, `room_number`,`room_name`, `purchase_date`, `user_type`,`status`) VALUES ('".$xarray[$i]."','".$accname."','".$getDate."','".$getTime."','".$hwname."', '".$hwtype."', '".$amount."','".$raminfo."', '".$mhzinfo."','".$slot."','".$crrram."','".$maxram."','".$speclink."','".$building."','".$floor."','".$roomnum."','".$roomname."','".$paydate."','".$type."','".$status."')";
                                                  ...
                                                  // $url = htmlspecialchars($_SERVER['HTTP_REFERER']);
                                                  $url = '/kis/admin1/pages/ticket/replyticket.php';
                                                  header("refresh: 0; url= '$url'" );
                                   }
