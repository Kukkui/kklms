                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <li role="presentation"><a href="#profile" data-toggle="tab">DEVICE-PLACE</a></li><!-- 
...
<button id="myBtn2" class='btn bg-cyan btn-block btn-sm waves-effect'>OPEN</button> -->
                                                ...
                                                <button id='myBtn2' class='btn btn-info btn-lg' >BULK EDIT</button>
                                                <button id='myBtn3' class='btn btn-info btn-lg' >BULK DELETE</button>
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT id,hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,age,user_type FROM hardware WHERE hw_name != '' AND deploy_date='-'";
                                        $result = mysql_query($sql);
                                        ...
                                        if (mysql_num_rows($result) > 0) {
                                            ...
                                            while($row = mysql_fetch_array($result)) {
                                                ...
                                                <button type='button' id='".$deviceid."' onclick='myFunction2(".$deviceid.")' class='btn btn-info waves-effect' data-toggle='modal' data-target='#myModal'>".
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT id,hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,user_type FROM hardware WHERE hw_name != '' AND deploy_date='-'";
                                        $result = mysql_query($sql);
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,user_type,age FROM hardware WHERE hw_name != ''";
                                        $result = mysql_query($sql);
...
// When the user clicks anywhere outside of the modal, close it
window.onclick = function(event) {
    if (event.target == modal3 || event.target == modal) {
