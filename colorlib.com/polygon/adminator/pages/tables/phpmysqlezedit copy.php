                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div id="wizard_horizontal">
                                <h2>First Step</h2>
                                <section>
                                    <input type="textarea" width="900px" id="one" name="one" placeholder="
                                        ...
                                        dolor, tristique ac tempus nec, iaculis quis nisi."></input>
                        ...
                        <div class="body">
                            <form id="wizard_with_validation" method="POST">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group form-float">
                                        <textarea name="textarea" cols="30" rows="5" class="form-control no-resize" required></textarea>
                                            <label class="form-label" placeholder="">CONTENT HERE</label>
                                    </div>
                                </fieldset>
