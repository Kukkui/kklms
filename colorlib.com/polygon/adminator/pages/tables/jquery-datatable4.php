                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT `account`,`date`,`time`,`hw_name`,`hw_type`,`amount`,`ram_info`,`mhz_info`,`slot_number`,`current_ram`,`max_ram`,`spec_link`,`building`,`floor`,`room_name`,`room_number`,`purchase_date`,`user_type` FROM hardwares ORDER BY `id` DESC";
