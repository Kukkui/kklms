                            ...
                            <div class="tab-content">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM hardware WHERE groups='ACCESSORY'";
                                        ...
                                        if (mysql_num_rows($result) > 0) {
                                            ...
                                            while($row = mysql_fetch_array($result)) {
                                                $idx=$row["id"];
                                                echo "<tr>";
                                                echo "<th scope='row'>" ."<button type='button' class='btn bg-cyan' onclick='toinfo(".$idx.")' >"."<i class='material-icons'>edit</i>"."</button>" . "</th>";
