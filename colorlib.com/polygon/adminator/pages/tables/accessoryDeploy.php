                            ...
                            <div class="tab-content">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT id,hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,user_type FROM hardware WHERE status ='DEPLOY' AND  groups='ACCESSORY'";
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,user_type FROM hardware WHERE status ='DEPLOY' AND  groups='ACCESSORY'";
                                        $result = mysql_query($sql);
