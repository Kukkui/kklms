...
<body class="theme-blue">
   ...
   <?php include '../../../mainnav.php'; ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-cyan">
                            <h2>
                                AVAILABLE CHECK-IN/OUT ACCESSORIES
                            </h2>
                            ...
                            <div class="tab-content">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM hardware WHERE hw_name != '' AND deploy_date='-' AND avail!=amount AND groups='ACCESSORY'";
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM hardware WHERE hw_name != '' AND deploy_date='-' AND avail>0 AND groups='ACCESSORY'";
                                        $result = mysql_query($sql);
    ...
    <script type="text/javascript">
        ...
        function tocout(num){
            var idx = num;
            window.location.href = "/kis/admin1/cout2.php?idx="+idx;
        }
        function tocin(num){
            var idx = num;
            window.location.href = "/kis/admin1/cin2.php?idx="+idx;
        }
    </script>
