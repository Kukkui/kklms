                            ...
                            <div class="table-responsive tablesaw-overflow">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM accessorytype WHERE 1";
...
<script src="../../plugins/multi-select/js/jquery.multi-select.js"></script>
    ...
    window.location.href = "/kis/admin1/pages/tables/settingedit.php?hwname2="+hwname2+"&okid="+str+"&groups=accessorytype";
...
function okay2() {
    ...
    document.getElementById("bulkid").innerHTML=str;
    window.location.href = "/kis/admin1/pages/tables/settingdelete.php?okid="+str+"&groups=accessorytype";
    // prompt(document.getElementById("hwtype").value);
    // prompt(document.getElementById("amount").value);
    // prompt(document.getElementById("raminfo").value);
...
function okay3() {
    ...
    document.getElementById("bulkid").innerHTML=str;
    window.location.href = "/kis/admin1/pages/tables/settingadd.php?hwname2="+hwname2+"&groups=accessorytype";
    // prompt(paydate2);
    // prompt(document.getElementById("amount").value);
    // prompt(document.getElementById("raminfo").value);
