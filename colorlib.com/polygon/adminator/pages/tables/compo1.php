...
<body class="theme-blue">
   ...
   <?php include '../../../mainnav.php'; ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <li role="presentation" class="active"><a href="#home" data-toggle="tab">COMPONENT-SPEC</a></li>
                                <li role="presentation"><a href="#profile" data-toggle="tab">COMPONENT-PLACE</a></li><!-- 
                            ...
                            <div class="tab-content">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM hardware WHERE groups LIKE '%COMPONENT%'";
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM hardware WHERE status='ACTIVE' AND  groups LIKE '%COMPONENT%'";
                                        $result = mysql_query($sql);
    ...
    <script type="text/javascript">
        function toinfo(num){
            var idx = num;
            window.location.href = "/kis/admin1/ezhwinfo.php?idx="+idx;
        }
    </script>
