...
<body class="theme-blue">
  ...
  <?php include '../../../mainnav.php'; ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-cyan">
                            <h2>
                             AVAILABLE CHECK-IN/OUT ASSET
                            </h2>
                            
                        </div>
                        <div class="body">
                                <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                <li role="presentation" class="active"><a href="#home" data-toggle="tab">CHECK IN</a></li>
                                <li role="presentation"><a href="#profile" data-toggle="tab">CHECK OUT</a></li><!-- 
                            ...
                            <div class="tab-content">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM hardware WHERE hw_name != '' AND deploy_date='-' AND avail!=amount AND avail!='-' AND groups='HARDWARE'";
                                        ...
                                        if (mysql_num_rows($result) > 0) {
                                            ...
                                            while($row = mysql_fetch_array($result)) {
                                                $idx=$row["id"];
                                                echo "<tr>";
                                                echo "<th scope='row'>" ."<button type='button' class='btn bg-cyan' onclick='tocin(".$idx.")' >"."CHECK-IN"."</button>" . "</th>";
                                                ...
                                                echo("<td>".$avails."</td>");
                                                if($avails!='-'){
                                                    $unavails=(int)$amount-(int)$avails;
                                                    echo("<td>".$unavails."</td>");
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM hardware WHERE hw_name != '' AND deploy_date='-'  AND avail>0 AND avail!='-' AND groups='HARDWARE'";
                                        $result = mysql_query($sql);
                                        ...
                                        if (mysql_num_rows($result) > 0) {
                                            ...
                                            while($row = mysql_fetch_array($result)) {
                                                $idx=$row["id"];
                                                echo "<tr>";
                                                echo "<th scope='row'>" ."<button type='button' class='btn bg-cyan' onclick='tocout(".$idx.")' >"."CHECK-OUT"."</button>" . "</th>";
                                                $devicename=$row["hw_name"];
                                                $devicetype=$row["hw_type"];
                                                $amount=$row["amount"];
                                                $raminfo=$row["ram_info"];
    ...
    <script type="text/javascript">
        // function toinfo(num){
        //     var idx = num;
        //     window.location.href = "/kis/admin1/cout.php?idx="+idx;
        // }
        function tocout(num){
            var idx = num;
            window.location.href = "/kis/admin1/cout.php?idx="+idx;
        ...
        function tocin(num){
            var idx = num;
            window.location.href = "/kis/admin1/cin.php?idx="+idx;
        }
    </script>
