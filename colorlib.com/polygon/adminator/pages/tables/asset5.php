...
<div id="myModal2" class="modal">
 ...
 <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="age2" value="-" class="form-control show-tick" data-live-search="true" placeholder="UN-CHANGE" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" />
                            ...
                            <div class="table-responsive tablesaw-overflow">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT id,hw_name,hw_type,amount,ram_info,mhz_info,slot_number,current_ram,max_ram,spec_link,building,floor,room_name,room_number,purchase_date,age,user_type FROM hardware WHERE hw_name != '' AND deploy_date='-' AND groups='HARDWARE'";
                                        $result = mysql_query($sql);
