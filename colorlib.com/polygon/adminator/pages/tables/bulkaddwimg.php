<?php             
    ...
    // $amount = $_COOKIE['get_amount'];
                                        ...
                                        // $xarray_size=count($xarray);
                                                  ...
                                                  $sql = "INSERT INTO `hardware`(`hw_name`, `hw_type`, `amount`,`avail`,`ram_info`, `mhz_info`, `slot_number`,`current_ram`, `max_ram`, `spec_link`,`building`, `floor`, `room_number`,`room_name`, `purchase_date`, `user_type`, `groups`) VALUES ('".$hwnamex."', '".$hwtypex."', '".$amountx."','".$amountx."','".$raminfox."', '".$mhzinfox."','".$slotx."','".$crrramx."','".$maxramx."','".$speclinkx."','".$buildingx."','".$floorx."','".$roomnumx."','".$roomnamex."','".$paydatex."','".$typex."','".'HARDWARE'."')";
