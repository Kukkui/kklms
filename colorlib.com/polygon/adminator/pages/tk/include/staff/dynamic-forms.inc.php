<form action="quizzes.php" method="POST" name="forms">
...
<div class="sticky bar opaque">
    <div class="content">
        ...
        <div class="pull-right flush-right">
            <a href="quizzes.php?a=add" class="green button action-button"><i class="icon-plus-sign"></i> <?php
            ...
            <div id="action-dropdown-more" class="action-dropdown anchor-right">
                <ul id="actions">
                    <li class="danger">
                        <a class="confirm" data-name="delete" href="quizzes.php?a=delete">
