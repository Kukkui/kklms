...
include_once(INCLUDE_DIR.'class.csrf.php'); //CSRF token class.
include_once(INCLUDE_DIR.'class.migrater.php');
include_once(INCLUDE_DIR.'class.plugin.php');
include_once INCLUDE_DIR . 'class.message.php';
...
class osTicket {
    ...
    function __construct() {
        ...
        include_once(INCLUDE_DIR.'class.config.php'); //Config helper
        include_once(INCLUDE_DIR.'class.company.php');
