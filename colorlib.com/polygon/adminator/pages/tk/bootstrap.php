...
class Bootstrap {
    ...
    function loadCode() {
        ...
        include_once INCLUDE_DIR.'class.util.php';
        ...
        include_once(INCLUDE_DIR.'class.format.php'); //format helpers
        include_once(INCLUDE_DIR.'class.validator.php'); //Class to help with basic form input validation...please help improve it.
        require(INCLUDE_DIR.'class.mailer.php');
        include_once INCLUDE_DIR.'mysqli.php';
        include_once INCLUDE_DIR.'class.i18n.php';
        include_once INCLUDE_DIR.'class.search.php';
    }
