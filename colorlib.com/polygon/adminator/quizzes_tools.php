                                                   ...
                                                   <div class='modal-dialog' role='document'>
                                                      <div class='modal-content'>
                                                         ...
                                                         <div class='modal-body'>
                                                               <form action='/kklms/colorlib.com/polygon/adminator/quizzes_tools_addx.php' method='post'>
                                                               <div class='form-row'>
                                                                  <div class='form-group col-md-12'><label for='inputEmail4'>New Quizz-ID</label><input type='text' class='form-control' id='qidx' name='qidx' value=<?php echo($randomx); ?> readonly></div>
...
<!-- Editable table -->
    ...
    <script type="text/javascript">
        function toinfo(num){
            ...
            window.location.href = "/kklms/colorlib.com/polygon/adminator/quizzes_tools_info.php?idx="+idx;
        }
    </script>
   </body>
   <!-- Mirrored from colorlib.com/polygon/adminator/forms.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jul 2020 12:13:35 GMT -->
