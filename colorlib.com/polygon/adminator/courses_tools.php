...
<!-- Editable table -->
                                                   ...
                                                   <div class='modal-dialog' role='document'>
                                                      <div class='modal-content'>
                                                         ...
                                                         <div class='modal-body'>
                                                               <form action='/kklms/colorlib.com/polygon/adminator/courses_tools_add.php' method='post'>
                                                               <div class='form-row'>
                                                                  <div class='form-group col-md-12'><label for='inputEmail4'>New Course-ID</label><input type='text' class='form-control' id='idx' name='idx' value='".$randomx."' readonly></div>
    ...
    <script type="text/javascript">
        function toinfo(num){
            ...
            window.location.href = "/kklms/colorlib.com/polygon/adminator/courses_tools2.php?idx="+idx;
        }
    </script>
   </body>
   <!-- Mirrored from colorlib.com/polygon/adminator/forms.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jul 2020 12:13:35 GMT -->
